...
public class HashtableIteratorTest {
	...
	public static void main(String[] args) {
		...
		//通过entrySet()遍历Hashtable的key-value值
		iteratorHashtableByEntryset(table);
		
		//通过keySet()遍历Hashtable的key-value值
    ...
    /*
     * 通过Eumeration遍历Hashtable的key
     * 效率高!
     */
	public static void enumHashtableKey(Hashtable table) {
		if (table == null) {
			return;
		}
    ...
    /*
     * 通过Eumeration遍历Hashtable的value
     * 效率高!
     */
	public static void enumHashtablevalue(Hashtable table) {
		if (table == null) {
			return;
		}
