package algorithm.test.linear.doublelink;

/**
 * @author j_cong
 * @date 2017年9月13日
 * @describe Java 实现的双向链表。 注：java自带的集合包中有实现双向链表，路径是:java.util.LinkedList
 * @version V1.0.0
 */
public class DoubleLinkTest {
	...
	private static void int_test() {
		...
		dlink.insert(0, 20); // 将 20 插入到第1个位置
		dlink.insert(1, 40); // 将 40 插入到第1个位置之前
