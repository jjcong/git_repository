package algorithm.test.graph.prim;
 ...
 * @author j_cong
 * @date 2017年9月14日
 * @describe 邻接矩阵无向图的prim算法生成最小生成树
 * @version V1.0.0
 */
public class MatrixUDGPrim {
	 ...
	 */
	public MatrixUDGPrim(char[] vexs, int[][] matrix) {
	...
	public static void main(String[] args) {
		...
		// pG = new MatrixUDG();
		// 采用已有的"图"
		pG = new MatrixUDGPrim(vexs, matrix);
